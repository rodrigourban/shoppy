...
class CustomUserTests(TestCase):
  def test_create_user(self):
    new_user = get_user_model().objects.create_user(username='newuser', email='newuser@gmail.com', password='testpassword123')
  ...
  def test_create_super_user(self):
    new_user = get_user_model().objects.create_superuser(username='superman', email='superman@gmail.com', password='testpassword123')
